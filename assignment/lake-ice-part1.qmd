...
```{r}
ggplot(sunapee, aes(year, ice_off_doy)) +
  geom_line() +
  geom_point(color = "deepskyblue4") +
  scale_x_log10() +
  theme_bw() +
  labs(title = "Ice off Day over the Years at Lake Sunapee", x = "Year", y = "Ice off Day of Year")
```
...
**Answer 2:** I expect the sign for the slope of the relationship to be negative because, in the earlier plot, the Ice off Day of Year was generally descending over the years.
